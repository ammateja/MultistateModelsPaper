...
# multistatemodels_paper

<!-- badges: start -->
<!-- badges: end -->

multistatemodels_paper provides a package for simulating and fitting multistate models
...
You can install the development version of multistatemodels_paper from
