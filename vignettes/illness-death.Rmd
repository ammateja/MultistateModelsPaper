...
First, ensure `Julia` (<span>&#8805;</span> version 1.10) is installed. Julia can be downloaded from https://julialang.org/downloads/.  After installing Julia, ensure that the `JuliaConnectoR` R package has been installed and loaded.
